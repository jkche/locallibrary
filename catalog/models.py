...
from django.urls import reverse # Used to generate URLs--reverses URL patterns

class Book(models.Model):
    """Model representing a book (but not a specific copy of a book)."""
    title = models.CharField(max_length=200)

    # Foreign Key used b/c book can only have one author, but authors can have
    # multiple books
    # Author as a string rather than object b/c it hasn't been declared yet in
    # the file
    ...
    # ManyToManyField used b/c genre can contain many books. Books can cover
    # many genres.
    ...
    def display_language(self):
        """Create a string for the Language. This is required to display genre in Admin."""
